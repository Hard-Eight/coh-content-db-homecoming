...
export const RegeneratingRaver: BadgeData = {
  type: 'pvp',
  key: 'regenerating-raver',
  ...
  icon: 'https://n15g.github.io/coh-content-db-homecoming/images/badges/pvp/regenerating-raver.png',
}
