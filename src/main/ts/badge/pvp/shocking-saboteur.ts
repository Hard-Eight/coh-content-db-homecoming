...
export const ShockingSaboteur: BadgeData = {
  type: 'pvp',
  key: 'shocking-saboteur',
  ...
  links: [
    { title: 'Shocking Saboteur Badge', href: 'https://homecoming.wiki/wiki/Shocking_Saboteur_Badge' },
  ],
  icon: 'https://n15g.github.io/coh-content-db-homecoming/images/badges/pvp/shocking-saboteur.png',
}
