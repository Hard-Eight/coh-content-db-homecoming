...
export const Percussionist: BadgeData = {
  type: 'pvp',
  key: 'percussionist',
  gameId: 'OnslaughtCarnivalDefeat',
  setTitleId: [2600],
  name: 'Percussionist',
  ...
  icon: 'https://n15g.github.io/coh-content-db-homecoming/images/badges/pvp/percussionist.png',
}
