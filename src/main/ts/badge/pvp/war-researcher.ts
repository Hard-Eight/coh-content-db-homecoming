...
export const WarResearcher: BadgeData = {
  type: 'pvp',
  key: 'war-researcher',
  ...
  links: [
    { title: 'War Researcher Badge', href: 'https://homecoming.wiki/wiki/War_Researcher_Badge' },
  ],
  icon: 'https://n15g.github.io/coh-content-db-homecoming/images/badges/pvp/war-researcher.png',
}
